        ...
        <div className="w-4 text-center    p-5	border-round-lg shadow-5">
            ...
            <div className="flex align-items-center justify-content-center m-5">
                ...
                <div className="card flex justify-content-center m-2">
                    <Checkbox onChange={e => setChecked(e.checked)} checked={checked} style={{ fontFamily: "'Geist Mono VF', monospace" }}></Checkbox>
                </div>
            ...
            <div className="flex flex-column justify-content-center align-items-center">
                ...
                <Button className="w-4 justify-content-center p-1 m-2 bg-white border-0 text-blue-500" onClick={() => {
                        route.push("/login")
                }} style={{ fontFamily: "'Geist Mono VF', monospace" }}>Do you have an acount?</Button>
            </div>
